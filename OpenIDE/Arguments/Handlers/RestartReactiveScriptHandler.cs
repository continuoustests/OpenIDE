...
{
    class RestartReactiveScriptHandler : ICommandHandler
    {
        ...
        public RestartReactiveScriptHandler(Action<string> dispatch, Func<PluginLocator> locator, string keyPath)
        {
            _dispatch = dispatch;
