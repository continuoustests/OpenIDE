...
{
    class PauseReactiveScriptHandler : ICommandHandler
    {
        ...
        public PauseReactiveScriptHandler(Action<string> dispatch, Func<PluginLocator> locator, string keyPath)
        {
            _dispatch = dispatch;
        ...
        public void Execute(string[] arguments)
        {
            ...
            if (script == null)
                return;
            _dispatch(string.Format("event|'reactive-script-pause' '{0}'", script.File));
        }
    }
}
